...
Während Anderson\cite{Anderson2002} auch die größten Asteroiden (ca. 0,2 Erdmassen) und Kometen – wenn auch nur mit dem Newtonschen Gravitationsgesetz – berücksichtigte, ignorierte Markward diese völlig.
...
\begin{minipage}[t]{.8\linewidth}
	...
	\label{fig:manoever}
  \caption{Doppler-Verschiebung durch ein Manöver (Nummer \#17, aus dem von Anderson\cite{Anderson2002} analysiertem Intervall; am 23. Dezember 1993)}
\end{minipage}
%\hfill
...
Markward verwendete dabei die ATDF-Dateien aus den öffentlich zugänglichen NSSDC-Archiven. % NSSDC-Archive ausschreiben
