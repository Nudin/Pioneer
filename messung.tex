...
Da das Radiosignal zirkular polarisiert ist, muss bei der Berechnung die Rotation der Sonde berücksichtigt werden. %mehr

Gerechnet wurde in der Standart-Epoche J200.0. %mehr
...
Die Angaben zu Abbremsung, sowie zur unregelmäßigkeit der Rotation, zur Polbewegung, die Love numbers\footnote{FIXME} und der Chandler wobble\footnote{Spiralfomiges Schwingen der Erdachse mit einer Periode von 435 Tagen} % Begriffe (genauer) erklären?
...
Aufgrund der Eigenrotation der Erde läßt sich andererseits aus den dopplerdaten auch die % – 3 dimensionale –
Entfernung der Sonde berechnen. %Aber nich besonders gut, wie wir später sehen werden	 	% mehr

% Die Zeitumrechnung fehlt
