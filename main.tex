...
Die Frequenzmessung erfolgte durch Zählen der Schwingungen und Vergleich mit einer Atomuhr.\cite{Nieto2007} % ``Schwingungen'' als Formulierung überprüfen
...
%Auch die ``Terrestrial and lunar figure effects``, die Gezeiten der Erde und die physische Libration wurde mit berücksichtigt.
...
Darüberhinaus wurden bei etlichen dieser Berechnungen eine Reihe von weiteren Einflüßen mit berücksichtigt, welche wir weiter unten % unter klassische Erklärungen
...
und er ist kleiner als die Faktoren $U/c^2$,$v^2/c^2$,$r a/c^2$ zur relativistischen Korrektur der newtonschen Dynamik. % richtig?
