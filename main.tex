...
% ToDo:
%% - Wohin mit
%%		* S-Band ist für 3-D wenig geeignet. (Route to Understanding, S. 0310)  ok
%%		* Analyse begann 1994 (Route to Understanding)
%%		* High rate Doppler data?				ok?
%% - Abgrenzung Navigation <> Einleitung		ok
...
%% - Namen im Text vereinheitlichen		ok
